...
<html>
	...
	<body>
		<a href="#edit-sala" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-sala" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:salaInstance, action:'update']" method="PUT" >
